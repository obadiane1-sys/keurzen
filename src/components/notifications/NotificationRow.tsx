...
const typeConfig: Record<InAppNotificationType, { icon: string; color: string }> = {
  task_reminder: { icon: 'alarm-outline', color: Colors.blue },
  overdue: { icon: 'warning-outline', color: Colors.coral },
  digest: { icon: 'newspaper-outline', color: Colors.mint },
  imbalance: { icon: 'scale-outline', color: Colors.lavender },
  invitation: { icon: 'person-add-outline', color: Colors.blue },
